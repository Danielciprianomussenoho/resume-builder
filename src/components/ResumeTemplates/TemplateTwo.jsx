...
const TemplateTwo = ({ resumeData, colorPalette, containerWidth }) => {
    ...
    useEffect(()=>{
        // calculate the scale factor based on the contaner width
        ...
        >
            <div className='px-10 pt-10 pb-5'>
                <div className='flex items-start gap-5 mb-5'>
                    ...
                    >
                        {resumeData.profileInfo.profilePreviewUrl ? (
                            <img 
                            src={resumeData.profileInfo.profilePreviewUrl} alt="" 
             ...
             <div className='mx-10 pb-5'>
                     <div className='mt-5'>
                        <Title text = "Resumo Profissional" color={themeColors[1]}/>
                    ...
                    <div className='mt-4'>
                        <Title text = "Experiência Profissional" color={themeColors[1]}/>
                      ...
                      <div className='mt-4'>
                        <Title text = "Projetos" color={themeColors[1]}/>
                      ...
                      <div className='mt-5'>
                            <Title text = "Educação" color={themeColors[1]}/>
                      ...
                      <div className='mt-4'>
                        <Title text = "Certificações" color={themeColors[1]}/>
                    ...
                    { resumeData.interests.length > 0 &&
                     ...
                     <div className=''>
                         <Title text = "Interesses" color={themeColors[1]}/>
